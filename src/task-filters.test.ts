...
describe('volunteer open-task marketplace', () => {
  it('shows every unexpired open task across caregiver accounts', () => {
    const marketplaceTasks = [
      { id: 'CK-301', ownerId: 'C-204', status: 'Open', scheduledAt: '2026-08-16T04:00:00.000Z' },
      { id: 'CK-302', ownerId: 'C-205', status: 'Open', scheduledAt: '2026-08-16T05:00:00.000Z' },
      { id: 'CK-303', ownerId: 'C-206', status: 'Open', scheduledAt: '2026-08-16T01:00:00.000Z' },
      { id: 'CK-304', ownerId: 'C-207', status: 'Matched', scheduledAt: '2026-08-16T06:00:00.000Z' },
    ]
